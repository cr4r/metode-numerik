...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Differensiasi</h1>
    <!-- DataTales Example -->
    <?php
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body mb-4">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td width="200px">Fungsi </td>
                                <td width="10px">:</td>
                                <td class="font-weight-bold">f(x) = x<sup>2</sup>+2x+1</td>
                            </tr>
                        </table>
                        <div class="row">
                            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body mb-4">
                        <form action="<?php echo base_url("differensiasi") ?>" method="POST">
                            <div class="row">
